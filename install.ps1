<#
    ...
    Author:  Phat Tan
    Version: 12.1 (UI Fix & Resize Patch)
...
$Form.Text = "PHAT TAN PC TOOLKIT V12.1"
$Form.Size = New-Object System.Drawing.Size(1180, 820) # [FIX] Tăng kích thước Form
...
# --- HEADER SECTION ---
$PnlHeader = New-Object System.Windows.Forms.Panel; $PnlHeader.Size = "1180, 80"; $PnlHeader.Dock = "Top"; $PnlHeader.BackColor = [System.Drawing.Color]::Transparent
...
$LblVer.Text = "TOOLKIT v12.1 ULTIMATE (Fixed UI)"
...
function New-GroupCard ($Title, $ColIndex) {
    ...
    $Flow.AutoScroll = $true # [FIX] Cho phép cuộn nếu nút tràn
    
    # Canh giữa nút trong Flow (Giữ lại logic này để resize đẹp)
...
function Add-StyledBtn ($Parent, $Text, $SubText, $Cmd) {
    ...
    $Btn.Text = "  $Text" 
    $Btn.Height = 55 # [FIX] Tăng chiều cao để không mất chữ
    $Btn.Width = 320 # [FIX] Set cứng chiều rộng ban đầu để tránh bị bé tí
    $Btn.FlatStyle = "Flat"
    $Btn.BackColor = $Colors.Dark.BtnBack
    $Btn.ForeColor = $Colors.Dark.Text
    $Btn.TextAlign = "MiddleLeft"
    $Btn.Font = New-Object System.Drawing.Font("Segoe UI", 11, [System.Drawing.FontStyle]::Bold) # [FIX] Font to hơn chút
    ...
    $Btn.Add_MouseEnter({ 
        ...
        $this.Padding = New-Object System.Windows.Forms.Padding(5,0,0,0) 
    })
    $Btn.Add_MouseLeave({ 
...
# --- FOOTER SECTION ---
$PnlFooter = New-Object System.Windows.Forms.Panel; $PnlFooter.Size = "1180, 80"; $PnlFooter.Dock = "Bottom"; $PnlFooter.BackColor = [System.Drawing.Color]::FromArgb(20,20,20)
...
$BtnInstall.Location = "430, 15" # [FIX] Căn giữa lại chút
...
$StatusLabel = New-Object System.Windows.Forms.ToolStripStatusLabel; $StatusLabel.Text = "Sẵn sàng phục vụ. PhatTanPC v12.1"; $StatusStrip.Items.Add($StatusLabel)
$Form.Controls.Add($StatusStrip)

# Nút Donate & Credit
$BtnDonate = New-Object System.Windows.Forms.Button; $BtnDonate.Text="☕ DONATE"; $BtnDonate.Location="1000,20"; $BtnDonate.Size="120,40"; $BtnDonate.BackColor="Gold"; $BtnDonate.FlatStyle="Flat"; $PnlFooter.Controls.Add($BtnDonate)
