...
$Form.Text = "CAU HINH FILE TU DONG - PHAT TAN PC (V8.0 CLEAN)"
$Form.Size = New-Object System.Drawing.Size(650, 550) # Giam chieu cao do bo muc Key
...
$BtnSave = New-Object System.Windows.Forms.Button; $BtnSave.Text = "TAO FILE XML"; $BtnSave.Location = "20,480"; $BtnSave.Size = "580,50"; $BtnSave.BackColor = "Cyan"; $BtnSave.ForeColor = "Black"; $BtnSave.Font=$FontBold

$BtnSave.Add_Click({
    $XMLPath = "$env:SystemDrive\autounattend.xml"
    try {
        if (!(Test-Path $XMLPath)) { (New-Object Net.WebClient).DownloadFile($XML_Url, $XMLPath) }
        ...
        # --- QUAN TRỌNG: XÓA SẠCH KEY MẶC ĐỊNH ---
        # De Core Module tu xu ly sau. O day xoa di de tranh loi BCD
        ...
        [System.Windows.Forms.MessageBox]::Show("DA TAO XML (NO KEY)!`nCore Module se tu dong dien Key sau.`nLuu tai: $XMLPath", "Phat Tan PC")
        $Form.Close()
