<#
    ...
    Version: 9.1 (WinFsp Fusion Engine + Feature Manager + Async + Font Fixed)
...
# =========================================================================================
# GLOBAL VARIABLES & FONT DEFINITIONS (FIXED CRASH)
# =========================================================================================
$ToolsDir = "$env:TEMP\PhatTan_Tools"

# ĐỊNH NGHĨA FONT CHUẨN ĐỂ KHÔNG BỊ VĂNG APP
...
$Form.Text = "WINDOWS MODDER STUDIO V9.1 (WINFSP FUSION ENGINE)"
...
$GbAct = New-Object System.Windows.Forms.GroupBox; $GbAct.Text="MENU EDIT (V9.1 WINFSP ENGINE)"; $GbAct.Location="20,100"; $GbAct.Size="845,300"; $GbAct.ForeColor="Lime"; $GbAct.Font = $FontText; $GbAct.Enabled=$false; $TabMod.Controls.Add($GbAct)
...
function Async-Optimize {
    ...
    $CLB = New-Object System.Windows.Forms.CheckedListBox; $CLB.Location="10,10"; $CLB.Size="410,360"; $CLB.BackColor="60,60,65"; $CLB.ForeColor="Cyan"; $CLB.Font=$FontText
